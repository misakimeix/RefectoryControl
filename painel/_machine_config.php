...
GlobalConfig::$CONNECTION_SETTING->DBName = "rfc";
...
/** the root url of the application with trailing slash, for example http://localhost/refecontrol/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'rfc/painel/';
