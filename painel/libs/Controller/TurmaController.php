...
class TurmaController extends AppBaseController
{
	...
	public function Query()
	{
		try
		{
			...
			if ($filter) $criteria->AddFilter(
				new CriteriaFilter('Idturma,Nometurma,Turno'
				, '%'.$filter.'%')
			);
	...
	public function Create()
	{
		try
		{
			...
			$turma->Nometurma = $this->SafeGetVal($json, 'nometurma');
			$turma->Turno = $this->SafeGetVal($json, 'turno');
	...
	public function Update()
	{
		try
		{
			...
			$turma->Nometurma = $this->SafeGetVal($json, 'nometurma', $turma->Nometurma);
			$turma->Turno = $this->SafeGetVal($json, 'turno', $turma->Turno);
