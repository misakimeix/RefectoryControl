...
require_once("DAO/AdministradorCriteriaDAO.php");

/**
 * The AdministradorCriteria class extends AdministradorDAOCriteria and is used
 ...
 * @version 1.0
 */
class AdministradorCriteria extends AdministradorCriteriaDAO
{
