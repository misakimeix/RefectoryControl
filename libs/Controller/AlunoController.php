...
class AlunoController extends AppBaseController
{
	...
	public function Query()
	{
		try
		{
			...
			if ($filter) $criteria->AddFilter(
				new CriteriaFilter('Idaluno,Matricula,Nome,Senha,Turma,Imagem,Condicao'
				, '%'.$filter.'%')
			);
	...
	public function Create()
	{
		try
		{
			...
			$aluno->Matricula = $this->SafeGetVal($json, 'matricula');
			$aluno->Nome = $this->SafeGetVal($json, 'nome');
			$aluno->Senha = $this->SafeGetVal($json, 'senha');
			$aluno->Turma = $this->SafeGetVal($json, 'turma');
			$aluno->Imagem = $this->SafeGetVal($json, 'imagem');
			$aluno->Condicao = $this->SafeGetVal($json, 'condicao');
	...
	public function Update()
	{
		try
		{
			...
			$aluno->Matricula = $this->SafeGetVal($json, 'matricula', $aluno->Matricula);
			$aluno->Nome = $this->SafeGetVal($json, 'nome', $aluno->Nome);
			$aluno->Senha = $this->SafeGetVal($json, 'senha', $aluno->Senha);
			$aluno->Turma = $this->SafeGetVal($json, 'turma', $aluno->Turma);
			$aluno->Imagem = $this->SafeGetVal($json, 'imagem', $aluno->Imagem);
			$aluno->Condicao = $this->SafeGetVal($json, 'condicao', $aluno->Condicao);
