...
require_once("DAO/CardapioCriteriaDAO.php");

/**
 * The CardapioCriteria class extends CardapioDAOCriteria and is used
 ...
 * @version 1.0
 */
class CardapioCriteria extends CardapioCriteriaDAO
{
